...
public class Vitamin 
{
	...
	public void vitamin() 
	{
		...
		//타이틀 중앙 이미지
		ImageIcon mTitle = new ImageIcon("image/vitamin/youtprotin.png");
		...
		//제품 이미지
		ImageIcon vitamin1 = new ImageIcon("image/vitamin/vitamin1.png");
		JLabel vita1 = new JLabel(vitamin1);
		vita1.setBounds(60, 140,250 ,306);
		vita1.setVisible(true);

		ImageIcon vitaminAZ = new ImageIcon("image/vitamin/vitaminAZ.png");
		JLabel vita2 = new JLabel(vitaminAZ);
		vita2.setBounds(320, 145, 270, 306);
		vita2.setVisible(true);

		ImageIcon alphaMen = new ImageIcon("image/vitamin/AlphaMen.png");
		JLabel vita3 = new JLabel(alphaMen);
		vita3.setBounds(570,140,290,306);

		ImageIcon multVitamin = new ImageIcon("image/vitamin/multivitamin.png");
		...
		for(int i = 0; i < btnArr.length; i++) {
			...
			btnArr[i].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					switch(index) {
					case 0: JOptionPane.showMessageDialog(vita1, "마카 구매 완료");
					break;
					case 1: JOptionPane.showMessageDialog(vita2, "A-Z멀티비타민 구매 완료");
					break;
					case 2: JOptionPane.showMessageDialog(vita3, "알파맨 멀티비타민 구매 완료");
					break;
					case 3: JOptionPane.showMessageDialog(vita4, "데일리 멀티비타민 구매 완료");
					break;
					}
		...
		//제품 금액 배열 생성
		String price[] = {"$12.49", "$11.74", "$15.63", "$11.74"};
		Label[] pri = new Label[4];

		//제품 금액 for문으로 반복후 위치 지정
		for(int i = 0; i < price.length; i++) {
			pri[i] = new Label(price[i]);
			int x = 100;
			int y = 530;
		...
		//제품 이벤트 설명 이미지 첨부
		ImageIcon makainfo = new ImageIcon("image/vitamin/makainfo.png");
		JLabel mi = new JLabel(makainfo);
		mi.setBounds(80, 570, 230, 140);
		mi.setVisible(true);

		ImageIcon multiinfo = new ImageIcon("image/vitamin/multiinfo.PNG");
		JLabel mi1 = new JLabel(multiinfo);
		mi1.setBounds(330, 570, 230, 140);
		mi1.setVisible(true);

		ImageIcon alphamen = new ImageIcon("image/vitamin/alphainfo.PNG");
		JLabel apm = new JLabel(alphamen);
		apm.setBounds(610, 560, 230, 140);
		apm.setVisible(true);

		ImageIcon daliyinfo = new ImageIcon("image/vitamin/daliyinfo.PNG");
